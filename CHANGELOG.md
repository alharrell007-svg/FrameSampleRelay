...
- Retain inherited model results, known hallucinations, sampled-frame/no-audio limits, conditional local privacy and unverified second-computer/platform coverage.
- Advance metadata/version to rc.3. Server, setup and access-control logic are unchanged. Existing installations and prior archives remain untouched.

No private screenshots, transcripts, model responses, configurations, test records or binaries are included. The approved copyright name and GitHub account are intentional public attribution; no email address is included.
